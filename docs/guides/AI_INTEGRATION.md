...
| 5 | **[profiles/im-bot-shell.md](../profiles/im-bot-shell.md)** | Vendor-neutral: who maps platform IDs into `context`, who documents transport to the Engine, attachment pipelines, Engine truth tables |
